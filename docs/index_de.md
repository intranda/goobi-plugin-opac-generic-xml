...
Die Datei `plugin_intranda_opac_xml-lib.jar` enthält die Funktionalität zum parsen der XML Daten und muss für den Nutzer `tomcat` lesbar in folgendes Verzeichnis installiert werden:
